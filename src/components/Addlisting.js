  ...
  {successMessage ? <div className='text-center'><p className="text-green-800 font-semibold text-2xl">{successMessage}</p></div> : null}
    ...
    <h2 className='text-4xl font-bold text-center py-8'><span className='text-violet-800 font-semibold'>Add</span>listings.</h2>
     ...
     <div className='flex flex-col mb-4'>
       ...
       <input className="border relative bg-gray-100 p-2" type="text" value={title}
          placeholder="Title" onChange={(e)=>setTitle(e.target.value)}/>
       </div>
       <div className='flex flex-col mb-4'>
         <label  className='font-semibold'>Address</label>
         <input className='border relative bg-white p-2' type="text" value={address} 
       placeholder="Address"
       onChange={(e)=>setAddress(e.target.value)}/>
       </div>
       <div className='flex flex-col mb-4'>
         <label  className='font-semibold'>Area Name</label>
         <input className='border relative bg-white p-2' type="text" value={area_name} 
       ...
       <div className='grid w-1/5 mr-1'>
         ...
         <input className='border relative bg-white p-2 ' type="number"  value={rent} 
       placeholder="Rent ₹" 
       ...
       <div className='grid w-1/5 mr-1'>
        ...
        <input className='border relative bg-white p-2 ' type="number"  value={area} 
      ...
      />
       ...
       <div className='container'>
         ...
         <input type='radio' value='House' name='type'
       ...
       <div className='grid w-1/5 mr-1'>
         ...
         <input className='border relative bg-white p-2' type="numeric" value={bedroom_count} 
       placeholder="Bedrooms"
       onChange={(e)=>setBedroom_count(e.target.value)}/>
       </div>
       <div className='grid w-1/5 mr-1'>
         <label  className='font-semibold'>Bathrooms</label>
         <input className='border relative bg-white p-2' type="numeric" value={bathroom_count} 
